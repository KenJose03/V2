  ...
  return (
    ...
    >
        <div className="flex-1 flex flex-col items-center justify-center w-full relative px-6 space-y-2">
            <h1 className="text-9xl leading-[0.85] tracking-tight text-white select-none" style={{ fontFamily: 'Chunko, sans-serif', fontWeight: 'bold' }}>
            DIBS!
            </h1>
            <p className="text-sm font-black tracking-[0.3em] text-white uppercase font-sans">
            ...
            <input
                ...
                className="w-full max-w-xs bg-white/20 border-b border-white text-white font-mono text-center py-4 focus:outline-none focus:border-white transition-colors uppercase placeholder:text-white/50"
            />

            <div className="flex gap-4 w-full max-w-xs">
                <button onClick={() => handleStart('host')} className="flex-1 py-4 border border-white hover:bg-white hover:text-[#FF6600] transition-colors flex flex-col items-center gap-2 group">
                    <Video className="w-4 h-4" />
                    <span className="font-mono text-[10px] tracking-widest uppercase">Host</span>
                </button>
                <button onClick={() => handleStart('audience')} className="flex-1 py-4 border border-white hover:bg-white hover:text-[#FF6600] transition-colors flex flex-col items-center gap-2 group">
