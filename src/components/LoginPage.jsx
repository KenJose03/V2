      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1">
                ...
                <div className="relative group">
                    ...
                    <input 
                        ...
                        className="w-full bg-white/20 border border-white rounded-xl py-3 pl-10 pr-4 text-sm font-mono text-white focus:outline-none focus:border-white transition-colors placeholder:text-white/50"
                    />
                </div>
            </div>
            ...
            <button 
                type="submit"
                disabled={loading}
                className="w-full bg-white text-[#FF6600] font-black uppercase tracking-widest py-4 rounded-xl hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2 mt-4"
            >
                {loading ? (
